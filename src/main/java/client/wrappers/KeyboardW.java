...
public class KeyboardW {
    ...
    public static final int KEY_ARROW_RIGHT = GLFW_KEY_RIGHT;
    public static final int KEY_ARROW_LEFT = GLFW_KEY_LEFT;
    public static final int KEY_ARROW_DOWN = GLFW_KEY_DOWN;
    public static final int KEY_ARROW_UP = GLFW_KEY_UP;
    ...
    public static final int KEY_NUMPAD_0 = GLFW_KEY_KP_0; //KP is keypad, also known as numpad
    public static final int KEY_NUMPAD_1 = GLFW_KEY_KP_1;
    public static final int KEY_NUMPAD_2 = GLFW_KEY_KP_2;
    public static final int KEY_NUMPAD_3 = GLFW_KEY_KP_3;
    public static final int KEY_NUMPAD_4 = GLFW_KEY_KP_4;
    public static final int KEY_NUMPAD_5 = GLFW_KEY_KP_5;
    public static final int KEY_NUMPAD_6 = GLFW_KEY_KP_6;
    public static final int KEY_NUMPAD_7 = GLFW_KEY_KP_7;
    public static final int KEY_NUMPAD_8 = GLFW_KEY_KP_8;
    public static final int KEY_NUMPAD_9 = GLFW_KEY_KP_9;
    public static final int KEY_NUMPAD_DOT = GLFW_KEY_KP_DECIMAL;
    public static final int KEY_NUMPAD_DIVIDE = GLFW_KEY_KP_DIVIDE;
    public static final int KEY_NUMPAD_MULTIPLY = GLFW_KEY_KP_MULTIPLY;
    public static final int KEY_NUMPAD_SUBTRACT = GLFW_KEY_KP_SUBTRACT;
    public static final int KEY_NUMPAD_ADD = GLFW_KEY_KP_ADD;
